...
cs_rels_from_a7_virtual - This script will extract the ComputerSystem Relations knowledge from Assetcenter.
...
This script will extract the ComputerSystem virtual server information from Assetcenter. It will extract the knowledge that is available in the Relations file and feed it into the tables in the CIM database.

=head1 SYNOPSIS

 cs_rels_from_a7_virtual.pl [-t] [-l log_dir] [-c]

 cs_rels_from_a7_virtual -h	Usage
 cs_rels_from_a7_virtual -h 1  Usage and description of the options
 cs_rels_from_a7_virtual -h 2  All documentation
...
my $msg = "Getting Virtual Systems";
print "$msg\n";
logging ($msg);
