...
product_rels_from_esl - Extract Product Relations from ESL.
...
This script will extract the Product Relations from ESL. 

=head1 SYNOPSIS

 product_rels_from_esl.pl [-t] [-l log_dir] [-c]

 product_rels_from_esl.pl -h    Usage
 product_rels_from_esl.pl -h 1  Usage and description of the options
 product_rels_from_esl.pl -h 2  All documentation
